...
def cartesian_coordinates(orbitingobject, ax):
    n_points = 10000
    ...
    ax.plot(x, -y, color="#2f7bf5")
    ax.plot(-orbitingobject.focal_distance, 0, marker="o", markersize=8, label="Sun", color="#dbc70d")
...
def polar_coordinates(orbitingobject, ax):
    n_points = 10000
...
def main():
    ...
    cartesian_coordinates(orbitingobject, s1)
    polar_coordinates(orbitingobject, s2)
    fig.legend()
    plt.tight_layout()
    plt.show()
